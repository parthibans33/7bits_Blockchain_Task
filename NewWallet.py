...
class Wallet:
    def __init__(self) -> None:
        ...
        self.wallet_address= self.acc.address
        self.wallet_key =self.acc.privateKey
        self.Wallet_Details()
        pass
    ...
    def made_transactions(self):  
        ...
        amu =int(input("Enter the Amount in Ether:"))
        value=self.w3.toWei(amu, 'ether')
        ...
        transhash    =self.w3.eth.send_raw_transaction(signtransc.rawTransaction)
        self.t=self.w3.toHex(transhash)
        transaction_detail = {
...
class Details_Add(Wallet):
        ...
        def __init__(self) -> None:
            ...
            try:
                    ...
                    thash = Wallet.made_transactions(self.t)
                    self.transac_recepit = self.w3.eth.get_transaction(thash)
